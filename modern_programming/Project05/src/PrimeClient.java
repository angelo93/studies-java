...
//
//  Description:   Project 5 client test class.
//                 Instantiates:
//                 * PrimeClient
//
//********************************************************************
...
public class PrimeClient {
   ...
   public static void main(String[] args) {
      PrimeClient primeClient = new PrimeClient();
      primeClient.developerInfo();
      primeClient.runJob();
   ...
   public void runJob() {
      try {
         ...
         try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (running == true) {
               System.out.print("Please enter two integers, 'bye' to quit: ");
